        ...
        <div class="overlay">
            ...
            <div class="footer">
                <div class="footer-content">
                    <div class="btn">
                        <a id="prev" class="btn_prev" href="03_s1000.php" role="button"><span class="blind"></span></a>
                    </div>
                    <div class="info_area">
                        <div>헤어 컬러 완성</div>
                    </div>
                    <div class="btn">
                        <a id="next" class="btn_next" href="05_s2000" role="button"><span class="blind"></span></a>
                    </div>
                </div>
            </div>
        </div>
